...
class HttpServerProtocol(QuicConnectionProtocol):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.stream_buffers = defaultdict(str)
            ...
            while True:
                ...
                while "\n" in self.stream_buffers[stream_id]:
                    ...
                    if sensor_type == 'accel' and line.startswith("ACCEL:"):
                        await self.process_accel_data(line)
                    elif sensor_type == 'gyro' and line.startswith("GYRO:"):
                        await self.process_gyro_data(line)
                    else:
                        logging.warning(f"Unrecognized or malformed line: {line}")
